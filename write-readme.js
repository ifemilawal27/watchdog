...
const content = `# Watchdog - AI Risk Intelligence Dashboard for Bitget Agent Hub
...
console.log("README.md written successfully. Size: " + fs.statSync("README.md").size + " bytes");